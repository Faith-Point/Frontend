    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/country" element={<PrivateRoute element={<CountryPage />} />} />
          <Route path="/state" element={<PrivateRoute element={<StatePage />} />} />
          <Route path="/city" element={<PrivateRoute element={<CityPage />} />} />
          <Route path="/address" element={<PrivateRoute element={<AddressPage />} />} />
          <Route path="/role" element={<PrivateRoute element={<RolePage />} />} />
          <Route path="/faithPointImage" element={<PrivateRoute element={<FaithPointImagePage />} />} />
          <Route path="/faithPointRating" element={<PrivateRoute element={<FaithPointRatingPage />} />} />
          <Route path="/faithPointReligions" element={<PrivateRoute element={<FaithPointReligionsPage />} />} />
          <Route path="/faithPointSchedule" element={<PrivateRoute element={<FaithPointSchedulePage />} />} />
          <Route path="/faithPointService" element={<PrivateRoute element={<FaithPointServicePage />} />} />
          <Route path="/faithPointSubscription" element={<PrivateRoute element={<FaithPointSubscriptionPage />} />} />
          <Route path="/contact" element={<PrivateRoute element={<ContactPage />} />} />
          <Route path="/socialMedia" element={<PrivateRoute element={<SocialMediaPage />} />} />
        </Routes>
      </Router>
    </AuthProvider>
  );
